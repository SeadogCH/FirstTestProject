...
include "dbconnect.php";
	...
	if (mysql_num_rows($result1)>0) {
		...
		$message = "<html><body><p>Поздравляем, $username! Ваш пароль: $password</p><p>Пожалуйста, перейдите по <a href='http://test.webfck.net/seadogch/activate.php?id=$activationkey'>ссылке</a> для активации</p></body></html>";
